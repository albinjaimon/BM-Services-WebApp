<?php
// This page lets a user update their password.

session_start();

$page_title = 'Change Your Password';

// custom nav bar dependant on the users role
	...
	if (empty($errors)) { // If everything's OK.
		...
		if ($num == 1) { // Match was made.
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
				...
				<p>Your password has been updated. Later you will use it to log in!</p><p><br></p>';
