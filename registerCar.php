...
<?php 
// This script performs an INSERT query to add a record to the cars table.
session_start();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //  Format check for the character set for the Registration Plate
    ...
    // Presence check on user ID
    if (empty($_POST['user_id'])){
        $errors[]= "Select user email ";
    } else {
...
<form action="registerCar.php" method="post">
	...
	<p>Car Mileage: <input type="carMileage" name="carMileage" size="20" maxlength="6" value="<?php if (isset($_POST['carMileage'])) echo $_POST['carMileage']; ?>" > 
    <br>
    <br>

<!-- Select a foreign key but for ease the user email is displayed but the value is the equivalent userID -->
